...
public class Questao11 {
    public static void main(String[] args){
        ...
        log.cronometroStart();
        ps.ordenarInsercao(log);
        log.cronometroStop();

        log.criarLog("matrícula_insercao.txt");
        ps.escreverLista();
...
class Insercao extends Ordenador {
    ...
    public void ordenarInsercao(Arquivo log){
        ...
        for (int i = 1; i < this.numElementos; i++) {
            ...
            while ((j >= 0) && (verificarOrdemAlfabetica(this.lista[j].getAnoNascimento(), tmp.getAnoNascimento()) == 2)) {
                log.numComparacoes++;
