...
class AlgebraBooleana {
    ...
    private void resolver(){  //Resolver a expressao  
        int pos = 0;
        ...
        while(expressao.length() > 1){
            ...
            expressao = substituir(expressao, pos, posFinal);
            posFinal = pos;
            resp = portas(porta, bitArray);
            
            expressao = inserir(expressao, resp, pos);
            bitArray = "";
        }

        this.resposta = (int) resp.charAt(0) - '0';
    }
